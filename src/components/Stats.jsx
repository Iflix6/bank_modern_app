 ...
 const Stats = () => 
   (
     <section className={` ${styles.flexCenter}
        ...
        {stats.map((stat) => (
        <div key={stat.id} 
         className="{`flex-1 flex justify-start items-center flex-row m-3 mr-1 ml-1`}">
          <h4 className="font-poppins
          font-semibold xs:text-[40] text-[30px] xs:leading-[53px] 
          leading-[43px] text-white">{stat.value}
          </h4>
