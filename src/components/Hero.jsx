    ...
    ${styles.paddingY}`}>
      ...
      sm:px-16 px-6`}>
          ...
          <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
            Our team of expert uses a methodology to identify
            the credit cards most likely to fit yout needs.
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative`}>
        ...
        <div className="absolute z-[0] w-[50%] h-[35%] right-20 bottom-20 blue___gradient" />
      </div> 
